...
public class IncomeDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Income income = (Income) getIntent().getExtras().getSerializable("income");

        titleEditText.setText(income.getTitle());
        valueEditText.setText(income.getValue().toString());

        if (income.getAudioRecording() != null) {
            descriptionEditText.setVisibility(View.GONE);
            audioButton.setVisibility(View.VISIBLE);

            mediaPlayer = MediaPlayer.create(this, Uri.fromFile(income.getAudioRecording()));
