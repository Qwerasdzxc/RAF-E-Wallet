...
public class Outcome {
    ...
    public Outcome(Integer id, Integer value, String title, String description) {
        this.id = id;
        this.value = value;
        this.title = title;
    ...
    public Outcome(Integer id, Integer value, String title, File audioRecording) {
        this.id = id;
        this.value = value;
        this.title = title;
